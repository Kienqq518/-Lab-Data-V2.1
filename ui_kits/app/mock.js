...
(function () {
  ...
  const samples = [
    { id: 's1', code: 'SC2026/01001-01', name: '交联聚乙烯绝缘钢带铠装聚氯乙烯护套电力电缆', status: 'testing', cable: true, client: '杭州数蚕智能科技有限公司',
      tests: [
        { name: '导体直流电阻', device: 'dcr',  method: 'ocr',  status: 'done',    upload: 'done', phased: true, flow: { node: '数据审核' } },
        { name: '结构尺寸检查—导体&绝缘厚度&金属屏蔽', device: 'thk', method: 'auto', status: 'testing', count: 3, phased: true,
          subs: [
            { name: '导体', method: 'auto', phased: true,
              device: { name: '绝缘层机械性能智能测试系统-无人化版', code: 'YM-WRH-03', model: 'YWL-5D' },
              fields: [
                { key: 'jg', label: '导体结构' },
                { key: 'gs', label: '导体单丝根数', unit: '根' },
                { key: 'zj', label: '导体直径', unit: 'mm' },
              ] },
            { name: '绝缘厚度测量', method: 'manual', phased: true,
              device: { name: '台式测厚仪', code: 'DF291968', model: '(0~12.7)mm/0.001mm' },
              fields: [
                { key: 'hd', label: '绝缘各测量点厚度', unit: 'mm', multi: 6 },
              ] },
            { name: '金属屏蔽', method: 'ble', phased: true,
              device: { name: '数显卡尺', code: 'YBKC-02', model: '(0~300)mm/0.01mm' },
              fields: [
                { key: 'tdhd', label: '铜带厚度', unit: 'mm' },
                { key: 'tk1', label: '铜带宽度1', unit: 'mm' }, { key: 'dg1', label: '搭盖宽度1', unit: 'mm' },
                { key: 'tk2', label: '铜带宽度2', unit: 'mm' }, { key: 'dg2', label: '搭盖宽度2', unit: 'mm' },
                { key: 'tk3', label: '铜带宽度3', unit: 'mm' }, { key: 'dg3', label: '搭盖宽度3', unit: 'mm' },
                { key: 'tk4', label: '铜带宽度4', unit: 'mm' }, { key: 'dg4', label: '搭盖宽度4', unit: 'mm' },
                { key: 'tk5', label: '铜带宽度5', unit: 'mm' }, { key: 'dg5', label: '搭盖宽度5', unit: 'mm' },
              ] },
          ] },
        { name: '结构尺寸检查—非金属护套&钢带铠装', device: 'cal', method: 'ble',  status: 'testing', upload: 'pending', phased: false },
  ...
  window.MOCK = { stations, devices, samples, tasks, fieldTpl, methodLabel, testRules, allowManualInput, offDevices: devices.filter((d) => !d.station) };
})();
