  ...
  return (
    <React.Fragment>
      ...
      <div style={{
        ...
        <AnnotatedWrapper id="deviceSwitchDrawer" layout="block">
        ...
        <AnnotatedWrapper id="deviceSwitchFilter" layout="block">
          <div>
        ...
        <AnnotatedWrapper id="deviceSwitchList" layout="flex">
          <div style={{ flex: 1, overflow: 'auto', padding: 12, display: 'flex', flexDirection: 'column', gap: 8, minHeight: 0 }}>
            {visibleDevices.length ? visibleDevices.map((device) => {
              ...
              const stationText = M.stationLabel(device.station);
              return (
