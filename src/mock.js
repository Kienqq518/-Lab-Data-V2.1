...
/* 数蚕 Lab Data · 检测员 UI Kit 模拟数据
  ...
  // 消息通知（按委托任务为单位：returned 退回复测 / assigned 任务下发 / overdue 逾期预警；无系统公告）
  const notifications = [
    { id: 'n1', type: 'returned', title: '委托任务试验项被退回', taskCode: 'SC2026/01001',
      desc: '委托任务 SC2026/01001（交联聚乙烯绝缘钢带铠装聚氯乙烯护套电力电缆）下有分配给你的试验项被退回，请复测后重新上传。', returnNode: '数据审核', returnBy: '张伟', returnDept: '数据审核', at: '2026-07-06 14:30', read: false },
    { id: 'n2', type: 'returned', title: '委托任务试验项被退回', taskCode: 'SC2026/00490101',
      desc: '委托任务 SC2026/00490101（绝缘操作杆）下有分配给你的试验项被退回，请补测后重新提交。', returnNode: '技术负责人', returnBy: '李芳', returnDept: '技术负责人', at: '2026-07-07 10:12', read: false },
    { id: 'n3', type: 'assigned', title: '新委托任务下发', taskCode: 'SC2026/01002',
      desc: '委托任务 SC2026/01002（8.7/10kV-3 芯 电力电缆）已下发，含分配给你的样品试验项，检测时效 2026-07-10，请及时开检。', by: '系统', at: '2026-07-05 09:00', read: false },
    { id: 'n4', type: 'overdue', title: '任务逾期预警', taskCode: 'SC2026/01003',
      desc: '委托任务 SC2026/01003（8.7/10kV-3芯 电力电缆）已超过检测时效 2026-06-15，你名下仍有未完成试验项，请尽快处理以免影响报告出具。', by: '系统', at: '2026-07-04 08:00', read: true },
    { id: 'n5', type: 'assigned', title: '新委托任务下发', taskCode: 'SC2026/01630',
      desc: '委托任务 SC2026/01630（实壁类塑料电缆导管 带承口 PVC-C）已下发，含分配给你的样品试验项，检测时效 2026-07-11，请及时开检。', by: '系统', at: '2026-07-02 15:20', read: true },
    { id: 'n6', type: 'overdue', title: '任务逾期预警', taskCode: 'SC2026/00990',
      desc: '委托任务 SC2026/00990（交联聚乙烯绝缘钢带铠装聚氯乙烯护套电力电缆）已超过检测时效 2026-05-31，你名下仍有未完成试验项，请尽快处理。', by: '系统', at: '2026-06-30 08:00', read: true },
  ];
  ...
  /** 根据通知解析委托任务，供深链直达该任务 L3（展示分配给当前检测员的样品试验项） */
  function resolveNotificationTask(notification) {
    return tasks.find((t) => t.code === notification.taskCode) || null;
  }
